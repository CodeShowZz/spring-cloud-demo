package com.huangjunlin.spring-cloud.pages
...
import com.huangjunlin.spring-cloud.services.QaModule
...
class LoginSpec extends Specification {
    ...
    def setupSpec() {
        tester = new TapestryTester("com.huangjunlin.spring-cloud", "app", "src/main/webapp", QaModule.class)
    }
